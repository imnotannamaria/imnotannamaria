...
- 🎨 Maintaining [**entrepta**](https://entrepta.vercel.app/): 33 copy-paste components, 6 themes, installs with one `npx` command. Accessible and hardened by default.
...
- 🌱 **2026 open source challenge:** 6 open source projects (8/6)
...
- ⌚ Built [**wristkit**](https://wristkit-web.vercel.app/): Apple Watch activity rings on your Next.js site in minutes. Your data goes straight from your iPhone to your own Supabase — we never see it.
